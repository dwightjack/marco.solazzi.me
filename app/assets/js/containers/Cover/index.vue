        ...
        <section @wheel.passive="wheelListener" v-swipe.down="swipeDownHandler" v-show="active" :class="[$style.root, { [$style.isAppLoaded]: isAppLoaded }]" :id="id">
            ...
            <div :class="$style.body">
                ...
                <article :class="$style.text">
                    ...
                    <p>I am a 39yo <b>Frontend Web Developer</b>, technical <b>writer</b> and <b>speaker</b> from Verona (Italy). Living in Tokyo. I speak Italian (of course), English, French and some Japanese.</p>
